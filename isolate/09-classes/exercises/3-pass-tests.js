...
instanceA.write("x", 3);
instanceA.write("a", 0);
instanceB.write("tree", "oak");
const test5a = deepCompare(instanceA.entries, { a: 0, b: 2, x: 3 });
const test5b = deepCompare(instanceB.entries, { tree: "oak" });
console.assert(test5a, "Test 5.A - write");
console.assert(test5b, "Test 5.B");

const test6a = instanceA.read("b") === 2;
const test6b = instanceB.read("b") === undefined;
...
const test8a = deepCompare(instanceA.entries, { a: 0, x: 3 });
const test8b = deepCompare(instanceB.entries, { tree: "oak" });
